...
- `bad-note-Android-3.3.23-Update.apk`: 기존 `com.inkforge.note4` 설치판을 업데이트할 때 사용
- `bad-note-Android-3.3.23-SideBySide.apk`: 기존 앱과 별도로 설치할 때 사용
...
- 최신 변경 내역: `docs/CHANGELOG-3.3.23-KO.md`
